...
phoneDesc = ["Compact", "Clam Shell", "RoboPhone – 5-inch screen and 64GB memory",
...
while (True):
    ...
    if (additionalPhone == 1):
        ...
        discount = sum(bill) * 0.1
        updatedPrice = sum(bill) - discount
        totalDiscount = totalDiscount + discount

        print("Discounted Price with 10% off", updatedPrice)
        print("Money saved so far: ", totalDiscount)
